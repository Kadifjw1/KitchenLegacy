...
/**
 * Short flame segment left behind a moving blade, oriented along the blade's
 * direction of travel rather than the camera. The calling code is expected
 * to spawn a fresh one every 1-2 ticks during a swing.
 */
public class FireTrailParticle extends OrientedFireParticle {
